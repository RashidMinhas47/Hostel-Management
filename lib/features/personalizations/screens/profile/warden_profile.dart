...
import "package:hostel_management/features/personalizations/screens/setting/warden_settings.dart";
...
class WardenProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final  wardenCtr = Get.put(WardenCtr());
            ...
            child:  Center(
              child: Obx(
                    ...
                    return controller.isLoading.value ?  CircularProgressIndicator():  ProfileAvatar(
                      ...
                      username: wardenCtr.student.value?.firstName ?? "Not Loaded",
                    );
                  }
              ),
            ),
