...
class OutingLeaveController extends GetxController {
  ...
  void sendLeaveRequest() async {
    ...
    try {
      final outingRef = database.child(FirebaseStrings.outingLeave).child(uid!).push();
      ...
      Get.snackbar("Success", "Outing leave request submitted successfully.");
      emailController.clear();
      messageController.clear();
      Get.offAll(() => DeciderScreen());
    } catch (e) {
      Get.snackbar("Error", "Something went wrong. Please try again.");
      debugPrint("OutingLeave Error: $e");
    } finally {
