...
import 'package:hostel_management/features/student_dashboard/screens/home/controllers/outing_leave_ctr.dart';
...
class OutingFormView extends StatelessWidget {
  const OutingFormView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(OutingLeaveController());
    ...
    return Scaffold(
      ...
      appBar: TAppBar(
        ...
        title: TTitleSmall(label: "leave outing"),
      ),
      body: Container(
...
sectionSpace,
              ...
              Obx(() => controller.isLoading.value
                  ...
                  : TLargeButton(label: 'Send', onPressed: controller.sendLeaveRequest)),
